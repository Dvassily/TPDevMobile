...
public class MainActivity extends AppCompatActivity {
    public static final String EXTRA_NAME = "com.example.tp1exercice6.NAME";
    public static final String EXTRA_FIRST_NAME = "com.example.tp1exercice6.FIRST_NAME";
    public static final String EXTRA_AGE = "com.example.tp1exercice6.AGE";
    public static final String EXTRA_SKILL = "com.example.tp1exercice6.SKILL";
    public static final String EXTRA_PHONE = "com.example.tp1exercice6.PHONE";
